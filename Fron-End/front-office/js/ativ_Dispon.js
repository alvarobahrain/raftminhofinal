...
function readActivities() {
    async function fetchAsync() {
        ...
        const response1 = await fetch('https://raftminho.herokuapp.com/activities/3');
        ...
        const response2 = await fetch('https://raftminho.herokuapp.com/activities/13');
        ...
        const response3 = await fetch('https://raftminho.herokuapp.com/activities/10');
