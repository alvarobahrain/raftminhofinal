...
function quizCorrect() {
    ...
    let response1 = await fetch(`https://raftminho.herokuapp.com/activities/${correctQuizActivity}`);
    ...
    let response2 = await fetch(`https://raftminho.herokuapp.com/spaces/${id_space}`);
        ...
        (function quizz3 () {
            function buildQuiz() {
             ...
             async function showResults() {
              ...
              let response10 = await fetch(`https://raftminho.herokuapp.com/rankings/${idUser}`);
                ...
                if(numCorrect==1) {
                    ...
                    fetch(`https://raftminho.herokuapp.com/rankings/${idUser}`, {
                        headers: {
